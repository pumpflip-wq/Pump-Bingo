        ...
        <TooltipProvider>
          <div className="flex h-screen w-full bg-background text-foreground overflow-hidden">
            <div className="flex flex-col flex-1 relative overflow-hidden">
              <header className="w-full flex flex-col md:flex-row items-center justify-between pb-4 pt-4 gap-6 sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-white/5 px-4 sm:px-6 lg:px-8">
              ...
              >
                <div className="flex-1 pb-8 pt-0 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <Router />
                </div>
                <Footer />
              </main>
