                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-3">
                    <a 
                      ...
                      className="w-10 h-10 rounded-lg bg-white/10 hover:bg-white/20 transition-all flex items-center justify-center border border-white/20"
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="w-10 h-10 rounded-lg bg-white/10 hover:bg-white/20 transition-all flex items-center justify-center border border-white/20 text-white hover:text-primary"
                      title="Follow on X"
                    >
