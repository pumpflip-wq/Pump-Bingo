    ...
    <AnimatePresence>
      ...
      >
        <div className="relative bg-black/90 backdrop-blur-xl border-t border-primary/30 shadow-[0_-4px_40px_rgba(34,197,94,0.15)]">
          ...
          <div className="max-w-[1450px] mx-auto px-4 py-3 flex items-center gap-3">
            <button
              onClick={() => setDismissed(true)}
              className="shrink-0 w-7 h-7 flex items-center justify-center rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all text-white/40 hover:text-white/80 opacity-0 pointer-events-none"
              aria-hidden="true"
            >
            ...
            <div className="flex-1 flex items-center justify-center gap-2.5">
              ...
              <p className="text-xs lg:text-sm font-bold tracking-wide text-white/90 text-center">
                <span className="text-primary font-black">FREE MODE</span>
                <span className="text-white/50 mx-2">—</span>
                <span className="text-white/80">Play for free during our launch phase.</span>
                <span className="text-white/40 mx-2 hidden sm:inline">·</span>
                <span className="hidden sm:inline text-white/60">Real money games with </span>
                <span className="hidden sm:inline text-primary font-black">{PROTOCOL_CONFIG.SYMBOL}</span>
                <span className="hidden sm:inline text-white/60"> tokens coming soon.</span>
              </p>
            </div>
            <button
              onClick={() => setDismissed(true)}
