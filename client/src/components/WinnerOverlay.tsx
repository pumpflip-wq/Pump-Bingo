      ...
      {show && (
        ...
        >
          ...
          >
            ...
            <h2 className={`text-4xl font-display font-black mb-2 tracking-tighter uppercase italic ${isWinner ? 'text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]' : 'text-red-500'}`}>
            ...
            <div className="bg-black/40 rounded-3xl p-4 mb-6 border border-white/10 text-center relative overflow-hidden">
              <div className="space-y-4">
                <div>
                  <p className="text-[10px] text-white uppercase font-black tracking-widest mb-1 text-center">WINNER ADDRESS</p>
                  <p className="text-xl font-bold text-white italic truncate text-center">
                ...
                <div>
                  ...
                  <div className="flex flex-col items-center gap-0">
                    ...
                    <span className="text-[10px] font-black text-primary/70 italic uppercase tracking-[0.3em]">PBINGO TOKEN</span>
                  </div>
                </div>
                {explorerUrl && (
